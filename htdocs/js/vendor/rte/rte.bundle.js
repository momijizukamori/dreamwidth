...
/* harmony export */   "isNodeAttrActive": () => (/* binding */ isNodeAttrActive),
/* harmony export */   "isAttrActive": () => (/* binding */ isAttrActive),
/* harmony export */   "markItem": () => (/* binding */ markItem)
/* harmony export */ });
/* harmony import */ var _SimpleToolbar_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SimpleToolbar.js */ "./js/SimpleToolbar.js");
...
class ProsemirrorToolbar extends _SimpleToolbar_js__WEBPACK_IMPORTED_MODULE_0__.SimpleToolbar {
...
function isNodeAttrActive(node, attr, val) {
    return function(state) {
        let { doc, selection } = state;
        if (selection.empty) {
            let pos = selection.$head;
...
function markItem(mark, label, icon) {
    ...
    return {
        ...
        value: value,
        label: label,
        action: (0,prosemirror_commands__WEBPACK_IMPORTED_MODULE_2__.toggleMark)(mark),
...
/* harmony export */   "columnResizingPluginKey": () => (/* binding */ key$1),
...
/* harmony export */   "tableEditingKey": () => (/* binding */ key),
...
/* harmony export */   "updateColumnsOnResize": () => (/* binding */ updateColumns)
/* harmony export */ });
/* harmony import */ var prosemirror_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! prosemirror-state */ "./node_modules/prosemirror-state/dist/index.es.js");
/* harmony import */ var prosemirror_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prosemirror-model */ "./node_modules/prosemirror-model/dist/index.es.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initCutPlugin": () => (/* binding */ initCutPlugin)
/* harmony export */ });
/* harmony import */ var prosemirror_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! prosemirror-state */ "./node_modules/prosemirror-state/dist/index.es.js");
...
class CutView {
    constructor(node, view, getPos) {
        ...
        this.cutText.addEventListener('click', e => {
          ...
          let newSelect = new prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.TextSelection(resolved, resolved);
    ...
    if (event.key == 'Left' || event.key == 'ArrowLeft') {
        ...
        if (curr.depth > 1 && curr.node(curr.depth - 1).type.name == 'cut' && prev.type.name != 'cut') {
          ...
          if (selection.empty && view.hasFocus()) {
            ...
            let select = new prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.TextSelection(curr, resolved);
...
const initCutPlugin = new prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.Plugin({
  key: "cutPlugin",
      ...
      cuts.forEach(item => {
            ...
            if (newPos - oldPos == 3 && item.start < newPos < item.end && oldPos < item.start) {
                ...
                if (newState.selection.empty) {
                  ...
                  let select = new prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.TextSelection(resolved, resolved);
          ...
          if (oldPos == item.end - 2 && newPos == item.start - 1) {
              ...
              if (newState.selection.empty) {
                ...
                select = new prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.TextSelection(resolved, resolved);
                cutNode.lastChild.focus();
              } else {
                let resolved = newState.doc.resolve(item.end + 2);
                select = new prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.TextSelection(newState.selection.$anchor, resolved);
              }
              trans = newState.tr.setSelection(select);
          }
...
class ExportView {
    constructor(view, input, newNodes, newMarks) {
      ...
      this.schema = new prosemirror_model__WEBPACK_IMPORTED_MODULE_0__.Schema(this.spec);
      this.serializer = prosemirror_model__WEBPACK_IMPORTED_MODULE_0__.DOMSerializer.fromSchema(this.schema);
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "extMarks": () => (/* binding */ extMarks),
/* harmony export */   "extNodes": () => (/* binding */ extNodes)
/* harmony export */ });
...
/* harmony import */ var prosemirror_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prosemirror-model */ "./node_modules/prosemirror-model/dist/index.es.js");
/* harmony import */ var prosemirror_schema_basic__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! prosemirror-schema-basic */ "./node_modules/prosemirror-schema-basic/dist/index.es.js");
...
/* harmony import */ var prosemirror_tables__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! prosemirror-tables */ "./node_modules/prosemirror-tables/dist/index.es.js");
/* harmony import */ var orderedmap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! orderedmap */ "./node_modules/orderedmap/index.es.js");
...
const mappedNodes = orderedmap__WEBPACK_IMPORTED_MODULE_5__.default.from(_extended_schema_js__WEBPACK_IMPORTED_MODULE_0__.extNodes);

const listnodes = (0,prosemirror_schema_list__WEBPACK_IMPORTED_MODULE_3__.addListNodes)(mappedNodes, "text_wrapper block*", "block");

const mySchema = new prosemirror_model__WEBPACK_IMPORTED_MODULE_1__.Schema({
  nodes: listnodes.append((0,prosemirror_tables__WEBPACK_IMPORTED_MODULE_4__.tableNodes)({
    tableGroup: "block",
    cellContent: "block+",
    cellAttributes: {
      background: {
...
/* harmony export */   "startImageUpload": () => (/* binding */ startImageUpload)
/* harmony export */ });
/* harmony import */ var prosemirror_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! prosemirror-state */ "./node_modules/prosemirror-state/dist/index.es.js");
...
const placeholderPlugin = new prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.Plugin({
    state: {
      init() { return prosemirror_view__WEBPACK_IMPORTED_MODULE_1__.DecorationSet.empty; },
      apply(tr, set) {
        ...
        if (action && action.add) {
          ...
          let deco = prosemirror_view__WEBPACK_IMPORTED_MODULE_1__.Decoration.widget(action.add.pos, widget, {id: action.add.id});
  ...
  const startImageUpload = function(view, file, schema) {
    ...
    constructor(node, view, getPos, element) {    
      ...
      handle.onmousedown = (e) => {
        ...
        const onMouseUp = (e) => {        
          ...
          let nodeSelection = new prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.NodeSelection(resolved);
...
const keys = {
    ...
    "Mod-b": (0,prosemirror_commands__WEBPACK_IMPORTED_MODULE_2__.toggleMark)(_fullSchema_js__WEBPACK_IMPORTED_MODULE_3__.mySchema.marks.strong),
    "Mod-B": (0,prosemirror_commands__WEBPACK_IMPORTED_MODULE_2__.toggleMark)(_fullSchema_js__WEBPACK_IMPORTED_MODULE_3__.mySchema.marks.strong),
    "Mod-i": (0,prosemirror_commands__WEBPACK_IMPORTED_MODULE_2__.toggleMark)(_fullSchema_js__WEBPACK_IMPORTED_MODULE_3__.mySchema.marks.em),
    "Mod-I": (0,prosemirror_commands__WEBPACK_IMPORTED_MODULE_2__.toggleMark)(_fullSchema_js__WEBPACK_IMPORTED_MODULE_3__.mySchema.marks.em),
    "Mod-u": (0,prosemirror_commands__WEBPACK_IMPORTED_MODULE_2__.toggleMark)(_fullSchema_js__WEBPACK_IMPORTED_MODULE_3__.mySchema.marks.underline),
    "Mod-U": (0,prosemirror_commands__WEBPACK_IMPORTED_MODULE_2__.toggleMark)(_fullSchema_js__WEBPACK_IMPORTED_MODULE_3__.mySchema.marks.underline),
...
/* harmony import */ var prosemirror_commands__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! prosemirror-commands */ "./node_modules/prosemirror-commands/dist/index.es.js");
/* harmony import */ var prosemirror_keymap__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! prosemirror-keymap */ "./node_modules/prosemirror-keymap/dist/index.es.js");
/* harmony import */ var prosemirror_history__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! prosemirror-history */ "./node_modules/prosemirror-history/dist/index.es.js");
/* harmony import */ var prosemirror_schema_basic__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! prosemirror-schema-basic */ "./node_modules/prosemirror-schema-basic/dist/index.es.js");
/* harmony import */ var prosemirror_dropcursor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! prosemirror-dropcursor */ "./node_modules/prosemirror-dropcursor/dist/index.es.js");
/* harmony import */ var prosemirror_gapcursor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! prosemirror-gapcursor */ "./node_modules/prosemirror-gapcursor/dist/index.es.js");
/* harmony import */ var prosemirror_tables__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! prosemirror-tables */ "./node_modules/prosemirror-tables/dist/index.es.js");
/* harmony import */ var _fullSchema_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./fullSchema.js */ "./src/fullSchema.js");
/* harmony import */ var _keyCommands_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./keyCommands.js */ "./src/keyCommands.js");
/* harmony import */ var _rteToolbar_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./rteToolbar.js */ "./src/rteToolbar.js");
/* harmony import */ var _imageView_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./imageView.js */ "./src/imageView.js");
/* harmony import */ var _imagePlugin_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./imagePlugin.js */ "./src/imagePlugin.js");
/* harmony import */ var _exportPlugin_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./exportPlugin.js */ "./src/exportPlugin.js");
/* harmony import */ var _cutView_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./cutView.js */ "./src/cutView.js");
...
const { Plugin, TextSelection } = __webpack_require__(/*! prosemirror-state */ "./node_modules/prosemirror-state/dist/index.es.js");
const { Decoration, DecorationSet } = __webpack_require__(/*! prosemirror-view */ "./node_modules/prosemirror-view/dist/index.es.js");
...
let exportPlugin = new Plugin({
    view(editorView) {
        return new _exportPlugin_js__WEBPACK_IMPORTED_MODULE_15__.ExportView(editorView, document.querySelector('textarea[name=event]'));
    }
});
...
function setupRTE() {
  ...
  // format ProseMirror likes (close <user> tags, replace newlines with hard breaks)
    ...
    let doc = prosemirror_model__WEBPACK_IMPORTED_MODULE_2__.DOMParser.fromSchema(_fullSchema_js__WEBPACK_IMPORTED_MODULE_10__.mySchema).parse(domDoc);
    let state = prosemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorState.create({
        doc: doc,
        plugins: [
            ...
            _rteToolbar_js__WEBPACK_IMPORTED_MODULE_12__.menu,
            selectPlugin,
            _imagePlugin_js__WEBPACK_IMPORTED_MODULE_14__.placeholderPlugin,
            (0,prosemirror_tables__WEBPACK_IMPORTED_MODULE_9__.tableEditing)(),
            (0,prosemirror_tables__WEBPACK_IMPORTED_MODULE_9__.columnResizing)(),
            exportPlugin
        ],
    });
    let fix = (0,prosemirror_tables__WEBPACK_IMPORTED_MODULE_9__.fixTables)(state);
    if (fix) state = state.apply(fix.setMeta("addToHistory", false));

    let view = window.view = new prosemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView(document.querySelector("#rte"), {
        state: state,
        nodeViews: {
    ...
    document.getElementById("imageselector").addEventListener("change", (e) => {
        if (
            ...
            (0,_imagePlugin_js__WEBPACK_IMPORTED_MODULE_14__.startImageUpload)(
                view,
                file,
                _fullSchema_js__WEBPACK_IMPORTED_MODULE_10__.mySchema
            );
        }
    });
    return view;
...
/* harmony import */ var prosemirror_history__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prosemirror-history */ "./node_modules/prosemirror-history/dist/index.es.js");
/* harmony import */ var prosemirror_commands__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! prosemirror-commands */ "./node_modules/prosemirror-commands/dist/index.es.js");
/* harmony import */ var prosemirror_tables__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! prosemirror-tables */ "./node_modules/prosemirror-tables/dist/index.es.js");
/* harmony import */ var _js_ProsemirrorToolbar_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../js/ProsemirrorToolbar.js */ "./js/ProsemirrorToolbar.js");
/* harmony import */ var prosemirror_schema_list__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! prosemirror-schema-list */ "./node_modules/prosemirror-schema-list/dist/index.es.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils.js */ "./src/utils.js");
/* harmony import */ var prosemirror_state__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! prosemirror-state */ "./node_modules/prosemirror-state/dist/index.es.js");
/* harmony import */ var prosemirror_model__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! prosemirror-model */ "./node_modules/prosemirror-model/dist/index.es.js");
...
function insertLink(state, dispatch) {
    ...
    if (selection.empty) {
        ...
        let tr = state.tr.setStoredMarks([_fullSchema_js__WEBPACK_IMPORTED_MODULE_0__.mySchema.marks.link.create({href: href})]);
  ...
  const insertImage = (state, _, view) =>{
    ...
    var to = ref.to;
    var attrs = null;
    if (state.selection instanceof prosemirror_state__WEBPACK_IMPORTED_MODULE_7__.NodeSelection && state.selection.node.type == _fullSchema_js__WEBPACK_IMPORTED_MODULE_0__.mySchema.nodes.image)
  ...
  function insertEmbed(state, dispatch) {
    ...
    let {from, to} = selection;
      ...
      if (embedNode) {
        ...
        let embed = _fullSchema_js__WEBPACK_IMPORTED_MODULE_0__.mySchema.nodes.embed.create(attrs);
...
const menu = (0,_js_ProsemirrorToolbar_js__WEBPACK_IMPORTED_MODULE_4__.toolbarPlugin)([
    ...
    {type: 'menu', label: "Table Actions", id: 'tables', items: [
      ...
      {label:"Delete column", action: prosemirror_tables__WEBPACK_IMPORTED_MODULE_3__.deleteColumn},
      {label:"Insert row before", action: prosemirror_tables__WEBPACK_IMPORTED_MODULE_3__.addRowBefore},
      {label:"Insert row after", action: prosemirror_tables__WEBPACK_IMPORTED_MODULE_3__.addRowAfter},
      {label:"Delete row", action: prosemirror_tables__WEBPACK_IMPORTED_MODULE_3__.deleteRow},
      {label:"Delete table", action: prosemirror_tables__WEBPACK_IMPORTED_MODULE_3__.deleteTable},
      {label:"Merge cells", action: prosemirror_tables__WEBPACK_IMPORTED_MODULE_3__.mergeCells},
      {label:"Split cell", action: prosemirror_tables__WEBPACK_IMPORTED_MODULE_3__.splitCell},
      {label:"Toggle header column", action: prosemirror_tables__WEBPACK_IMPORTED_MODULE_3__.toggleHeaderColumn},
      {label:"Toggle header row", action: prosemirror_tables__WEBPACK_IMPORTED_MODULE_3__.toggleHeaderRow},
      {label:"Toggle header cells", action: prosemirror_tables__WEBPACK_IMPORTED_MODULE_3__.toggleHeaderCell},
    ]},
    {action:prosemirror_history__WEBPACK_IMPORTED_MODULE_1__.undo, label: 'Undo'},
    {action:prosemirror_history__WEBPACK_IMPORTED_MODULE_1__.redo, label: 'Redo'}
  ]);
...
function toggleUser(state, dispatch) {
    ...
    if (username) {
    let user = _fullSchema_js__WEBPACK_IMPORTED_MODULE_0__.mySchema.nodes.username.create({name: username});
...
function canAddNode(type) {
  return function(state) {
    let {doc, selection} = state;
    let {$anchor, $head} = selection;

    return doc.canReplaceWith($anchor.index(0), $head.index(0), _fullSchema_js__WEBPACK_IMPORTED_MODULE_0__.mySchema.nodes[type]);
  }
}

function canApplyNodeStyle(attr) {
  return function(state) {
      let {doc, selection} = state;
      let {from, to} = selection;
      let canApply = true;
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./src/rte.js");
