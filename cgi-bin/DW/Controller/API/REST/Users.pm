...
################################################
my $post_access =
    DW::Controller::API::REST->path( 'users/post_access.yaml', 1, { 'get' => \&post_access_get } );
...
################################################
my $trust = DW::Controller::API::REST->path( 'users/trust.yaml', 1,
    { get => \&trust_get, post => \&trust_post, delete => \&trust_delete } );
...
my $reading_check =
    DW::Controller::API::REST->path( 'users/reading_check.yaml', 1, { get => \&checkforupdates } );
