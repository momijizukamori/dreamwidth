...
# DW::Controller::Shop
#
# This controller is for general shop workflow handlers.
# Routes for specific shop items are in DW::Controller::Shop::Items
# and routes for miscellaneous shop pages are in DW::Controller::Shop::Misc
#
# Authors:
